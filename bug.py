...
def main_GUI():
    ...
    global Entry3_5, Entry3_6, Entry3_7, Entry3_8, Entry3_9, Entry3_10, Text2_1
    win = tk.Tk() 
    path_ = tk.StringVar()
    ...
    win_top = tk.Label(win,                                  
                       text="歡迎使用賓果對獎",
                       font=('Microsoft JhengHei UI', 12, 'bold'), bg="skyblue")
